/**
 * 意图：播放器 Popover 三件套（原始需求 2026-09-22 增强轮；二轮 2026-09-22
 * 修预览窗居中：left = clamp(锚点x − 实测宽度/2, 4, trackW − w − 4)，图片
 * onload 与 resize 时重算；面板上移至 track 顶边上方，不压墨迹图层/菱形标记）：
 ...
 * 附带共享小工具 clamp01/fmtClock（player.ts 亦复用，避免循环依赖）。零 any，strict。
 */
